...
#crear instancia
app = Flask(__name__) # CORRECCIÓN: Usar __name__

# Configuración de la base de datos PostgreSQL
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL')
#app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://pablo:KFZN4nzJJ6EWvxJVlR7SFJBDEgZLivIT@dpg-d2vp4evdiees738k37hg-a.oregon-postgres.render.com/db_tec_jpor"
...
class Estudiante(db.Model):
    __tablename__ = 'estudiantes' # CORRECCIÓN: Usar __tablename__ (doble guion bajo)
...
if __name__ == '__main__': # CORRECCIÓN: Usar __name__ y __main__
    app.run(debug=True)
